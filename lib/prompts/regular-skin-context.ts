...
- Widely used dermatologic drugstore lines (e.g. Cetaphil Gentle Skin Cleanser, CeraVe Hydrating Cleanser, simple fragrance-free moisturizers) with mostly mild INCI should usually score Good (65–79) or Excellent (80+), not Poor or Very Poor.
`.trim();
